    ...
    <div class="max-w-screen-xl mx-auto pb-20">
        ...
        <div class="mt-24 flex gap-20">
            ...
            <div class="w-2/3">
                ...
                <p class="mt-4">Berdiri sebagai CYBER WORLD ICAFE pada tahun 2015 dengan konsep cafe internet kecepatan
                    tinggi yang
                    buka 24 jam. Pada 2019 kami melakukan peremajaan diri dengan mengubah nama CYBER WORLD iCAFE menjadi
                    CW COFFEE.
                    Dengan gerakan garis yang dinamis menggambarkan spesialisasi CW COFFEE dalam meracik minuman-minuman
                    terbaik untuk konsumen kami, yang kemudian kami sebut sebagai #SAHABATSEJATIKU.</p>

                <button class="mt-6 bg-[#0A225E] text-white px-6 py-2 rounded-full">Read More</button>
            </div>
        </div>
        ...
        <div class="mt-24">
            <div class="flex justify-between items-center">
                ...
                <p class="text-xl text-[#0A225E] font-semibold">See More &#10132;</p>
            </div>

            <div class="mt-24 grid grid-cols-4 gap-10">
                <div class="bg-[#0A225E] p-6 rounded-[10px] relative">
                    <img src="assets/americano-arabica-transparent.png" class="absolute translate-y-[-25%]" />
